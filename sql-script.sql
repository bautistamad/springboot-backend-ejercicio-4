...
values(1, 'ASOCIACI�N ATL�TICA ARGENTINOS JUNIORS'),

      (2, 'CLUB ATL�TICO BELGRANO DE C�RDOBA'),

      (3, 'CLUB ATL�TICO BOCA JUNIOR'),

	  (4, 'CLUB ATL�TICO INDEPENDIENTE'),

	  (5, 'INSTITUTO ATL�TICO CENTRAL C�RDOBA'),

	  (6, 'RACING CLUB'),

	  (7, 'CLUB ATL�TICO RIVER PLATE'),

	  (8, 'CLUB ATL�TICO SAN LORENZO DE ALMAGRO'),

	  (9, 'CLUB ATL�TICO TALLERES'),

	  (10, 'CLUB ATL�TICO VELEZ SARSFIELD')
...
begin
  ...
  select apellido         = p.apellido,
		 ...
		 equipos          = '[' +
		                    ...
		                    stuff((select ',' + convert(varchar(5), nro_equipo)
		 ...
		 hobbies          = '[' +
		                    ...
		                    stuff((select ',' + convert(varchar(5), nro_actividad)

		                             from dbo.actividades_personas e (nolock)
...
-- execute dbo.get_datos_persona @id_persona='02000000E379D2A04ECF209485E3355D275A2BBF67568ED07062E4DD8F27343A0BAE52D7'
